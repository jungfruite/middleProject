...
<div>
   ...
   <div class="container">
      ...
      <form action="insert.do" method="post" name="frm"  onsubmit="return valid();">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               영어대소문자,숫자(3~8자) <input type="text" class="form-control" id="id"
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               한글(2~7자) <input type="text" class="form-control" id="name"
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               <input type="text" class="form-control" id="mail" name="memberMail"
               placeholder="abc@abc">
            </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-3">
               한글,영문 대소문자,숫자(1~8자) <input type="text" class="form-control" id="nickname"
                  name="memberNickName" placeholder="닉네임을 입력하세요">
            </div>
