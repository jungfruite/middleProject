...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String privateRoomName = (String) session.getAttribute("privateRoomName");
...
<div id="header">
   ...
   <div id="chatRoom">
      <span id="chatRoomName" style="display: none"><%=privateRoomName %></span>채팅 상대<br>
    ...
    <script type="text/javascript">
            ...
            <%if (ipAddress.equals("192.168.144.10")) {%>
               let webSocket = new WebSocket(
                     "ws://localhost/Spectrum/mbtiPrivateChat.do");
            <%} else {%>
               let webSocket = new WebSocket(
                     "ws://192.168.144.10/Spectrum/mbtiPrivateChat.do");
            <%}%>
       let messageText = document.getElementById("messageText");
       const room = "<%=privateRoomName %>";
      ...
      $('div.input-div textarea').val('');
          ...
          // 처음 접속 성공하면 
            webSocket.onopen = function onOpen(event){
               webSocket.send( createMessage("connect", room, myName.value));
            }
