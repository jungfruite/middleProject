...
@WebServlet("/report/userReportDelete.do")
public class DeleteUserReportServlet extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//1. 파라미터정보 가져오기
		
		String memberReportNum = req.getParameter("memberReportNum");
		...
		int cnt = reportService.deleteUserReport(memberReportNum);
		String msg = "";
		if(cnt>0) {
			msg="성공";
		}else {
