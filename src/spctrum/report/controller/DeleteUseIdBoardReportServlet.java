...
@WebServlet("/report/boardReportDeleteUseId.do")
public class DeleteUseIdBoardReportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/views/report/reportboarddeleteuseid.jsp")
		.forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int cnt = reportService.deleteBoardUseIdReport(memberId);
