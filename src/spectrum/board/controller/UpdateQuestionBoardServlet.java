...
@WebServlet("/board/questionupdate.do")
@MultipartConfig(
...
public class UpdateQuestionBoardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 4. 업데이트 화면으로 포워딩
				req.getRequestDispatcher("/WEB-INF/views/board/questionupdateForm.jsp")
					.forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int cnt = boardService.updateQuestionBoard(qbv);
		...
		/*req.getRequestDispatcher("/member/list.do")
			.forward(req, resp);*/
		String redirecturl =req.getContextPath() + "/board/questiondetail.do?msg=" + URLEncoder.encode(msg, "UTF-8")+"&&questionboardNumber=" +questionboardNumber;
